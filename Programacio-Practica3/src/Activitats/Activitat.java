...
public abstract class Activitat implements Serializable {
    ...
    public boolean estaEnPeriodeInscripcio(Data dataActual) {
        return !dataActual.dataPassada(dataFiInscripcio) && dataActual.comparaAmb(dataIniciInscripcio) >= 0;
    }
    ...
    }// en online tenemos override de esto
